        ...
        positionCred: function() {
            ...
            if (a) {
                var b = this.creditsPosition,
                    ...
                    k = this.realHeight,
                    l = this.type;
                if ("serial" == l || "xy" == l || "gantt" == l) d = this.marginLeftReal, g = this.marginTopReal, h = d + this.plotAreaWidth, k = g + this.plotAreaHeight;
                var l = 5 + d,
                    m = g + 5;
                "bottom-left" == b && (l = 5 + d, m = k - a - 3);
                "bottom-right" == b && (l = h - e - 5, m = k - a - 3);
                "top-right" == b && (l = h - e - 5, m = g + 5);
                c.left = l + "px";
                c.top = m + "px"
            }
        }
...
(function() {
    ...
    d.wedge = function(a, b, c, e, f, g, h, k, l, m, n, p, r, t) {
        ...
        e = a.set();
        var G;
        B && (u = q(10 * u), A = q(10 * A), x = q(10 * x), E = q(10 * E), v = q(10 * v), C = q(10 * C), z = q(10 * z), w = q(10 * w), b = q(10 * b), l = q(10 * l), c = q(10 * c), g *= 10, h *= 10, k *= 10, y *= 10, 1 > Math.abs(f) && 1 >= Math.abs(x - A) && 1 >= Math.abs(z - C) && (G = !0));
        f = "";
        var D;
        p && (F["fill-opacity"] = 0, F["stroke-opacity"] = m["stroke-opacity"] / 2, F.stroke = m.stroke);
        if (0 < l) {
            D = " M" + u + "," + (v + l) + " L" + A + "," + (C + l);
            B ? (G || (D += " A" + (b - g) + "," + (l + c - h) + "," + (b + g) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + x + "," + (z + l)), D += " L" + E + "," + (w + l), 0 < k && (G || (D += " B" + (b - k) + "," + (l + c - y) + "," + (b + k) + "," + (l + c + y) + "," + E + "," + (l + w) + "," + u + "," + (l + v)))) : (D += " A" + g + "," + h + ",0," + H + ",1," + x + "," + (z + l) + " L" + E + "," + (w + l), 0 < k && (D += " A" + k + "," + y + ",0," + H + ",0," + u + "," + (v + l)));
            D += " Z";
            var L = l;
            B && (L /= 10);
            ...
            D = a.path(" M" + u + "," + v + " L" + u + "," + (v + l) + " L" + A + "," + (C + l) + " L" + A + "," + C + " L" + u + "," + v + " Z", void 0, void 0, "1000,1000").attr(F);
            l = a.path(" M" + x + "," + z + " L" + x + "," + (z + l) + " L" + E + "," + (w + l) + " L" + E + "," + w + " L" + x + "," + z + " Z", void 0, void 0, "1000,1000").attr(F);
            e.push(D);
            e.push(l)
        }
        B ? (G || (f = " A" + q(b - g) + "," + q(c - h) + "," + q(b + g) + "," + q(c + h) + "," + q(A) + "," + q(C) + "," + q(x) + "," + q(z)), h = " M" + q(u) + "," + q(v) + " L" + q(A) + "," + q(C) + f + " L" + q(E) + "," + q(w)) : h = " M" + u + "," + v + " L" + A + "," + C + (" A" + g + "," + h + ",0," + H + ",1," + x + "," + z) + " L" + E + "," + w;
        0 < k && (B ? G || (h += " B" + (b - k) + "," + (c - y) + "," + (b + k) + "," + (c + y) + "," + E + "," + w + "," + u + "," + v) : h += " A" + k + "," + y + ",0," + H + ",0," + u + "," + v);
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (v = 0; v < u.length; v++) {
                var E = u[v];
                this.reversedOrder && (E = u[u.length - v - 1]);
                w = E.getBBox();
                var F;
                this.equalWidths ? F = A * (r + n + this.markerLabelGap) : (F = C, C = C + w.width + g + n);
                F + w.width > p && 0 < v && 0 !== A && (t++, F = A = 0, C = F + w.width + g + n, x = x + z + m, z = 0);
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            if (g) {
                ...
                var g = q / H,
                    G, D = b.set();
                D.translate((f - F) / 2 + 1, 1, NaN, !0);
                E.push(D);
                for (G = 1; G < H; G++) z = f + G * g, z = d.line(b, [1, F - 2], [z, z], c.gridColor, c.gridAlpha, 1), d.setCN(a, z, "zoom-grid"), D.push(z);
                z = new d.SimpleButton;
                z.setDownHandler(c.draggerDown, c);
                z.setClickHandler(c.draggerUp, c);
                z.init(b, F, g, k, l, m, n, p, r, t);
                ...
                c.previousY = NaN;
                z = new d.SimpleButton;
                C ? (F = b.set(), H = d.line(b, [-x, x], [0, 0], v, w, 1), G = d.line(b, [0, 0], [-x, x], v, w, 1), F.push(H), F.push(G), z.svgIcon = F) : z.setIcon(a.pathToImages + "plus.gif", c.iconSize);
            ...
            h && (h = b.set(), d.setCN(a, h, "zoom-control-pan"), e.push(h), E && E.translate(f, 4 * f), y = new d.SimpleButton, C ? y.svgIcon = d.line(b, [x / 5, -x + x / 5,
                x / 5
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function(a, b) {
            ...
            if (n) {
                ...
                q = E = 0;
                a.centeredReal ? (isNaN(a.right) || (E = C * w), isNaN(a.bottom) || (q = F * w)) : (E = C * w / 2, q = F * w / 2);
                D.translate(E, q, w, !0)
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < v.length) {
                    ...
                    if (isNaN(q)) {
                        ...
                        q = d.line(x, v, C, l, 1, E / n, k, !1, !1, !0);
                        ...
                        for (var k = "", D = 0; D < v.length - 1; D++) {
                            ...
                            G = H / 2 * q;
                            F = 270 + 180 * Math.acos(H / 2 /
                                G) / Math.PI;
                            isNaN(F) && (F = 270);
                            L < J && (u = 1);
                            0 < w && (F = -F);
                            k += "M" + L + "," + M + "A" + G + "," + G + ",0,0," + u + "," + J + "," + O;
                            a.arcRadius[D] = G;
                            a.distances[D] = H
                        }
                        q = x.path(k).attr(B);
                    ...
                    if ("none" != A) {
                        var I, K, N;
                        if ("end" == A || "both" == A) u = v[v.length - 1], D = C[C.length - 1], 1 < v.length ? (B = v[v.length - 2], I = C[C.length -
                            2]) : (B = u, I = D), I = 180 * Math.atan((D - I) / (u - B)) / Math.PI, isNaN(F) || (I += F), K = u, N = D, I = 0 > u - B ? I - 90 : I + 90;
                        t = [-r / 2 - .5, -.5, r / 2 - .5];
                        k = [r, -.5, r];
                        a.shiftArrow && "middle" != A && (k = [0, 1.2 * -r, 0]);
                        "both" == A && (r = d.polygon(x, t, k, m, p, 1, m, p, void 0, !0), z.push(r), r.translate(K, N, 1 / n, !0), isNaN(I) || r.rotate(I), d.setCN(c, q, "map-line-arrow"), void 0 != a.id && d.setCN(c, q, "map-line-arrow-" + a.id), a.fixedSize && f.push(r));
                        if ("start" == A || "both" == A) r = v[0], N = C[0], 1 < v.length ? (u = v[1], K = C[1]) : (u = r, K = N), I = 180 * Math.atan((N - K) / (r - u)) / Math.PI, isNaN(F) ||
                            (I -= F), K = r, I = 0 > r - u ? I - 90 : I + 90;
                        "middle" == A && (u = v[v.length - 1], D = C[C.length - 1], 1 < v.length ? (B = v[v.length - 2], I = C[C.length - 2]) : (B = u, I = D), K = B + (u - B) / 2, N = I + (D - I) / 2, I = 180 * Math.atan((D - I) / (u - B)) / Math.PI, isNaN(F) || (F = H / 2, G -= Math.sqrt(G * G - F * F), 0 > w && (G = -G), F = Math.sin(I / 180 * Math.PI), -1 == F && (F = 1), K -= F * G, N += Math.cos(I / 180 * Math.PI) * G), I = 0 > u - B ? I - 90 : I + 90);
